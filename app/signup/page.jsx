      ...
      <div className="max-w-6xl p-8 bg-white rounded-lg shadow-lg">
        ...
        <form>
          <div className="mb-6">
            ...
            <input type="text" name="name" id="name" className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-base" />
          </div>
          <div className="mb-6">
