        ...
        <div className='p-4 flex justify-between items-center'>
          ...
          <nav className='flex items-center space-x-4'>
            ...
            <div className='relative'>
              <input type='text' placeholder='Search' className='pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-purple-300 text-sm h-10' />
            ...
            {isLoggedIn ? (
              ...
              <div className='relative'>
                <button
                  ...
                  <div className='w-full h-full rounded-full overflow-hidden'>
                    <Image src={placeholderImage} alt='Profile' className='object-cover' width={40} height={40} />
                  </div>
                </button>
                {isPopoverOpen && (
              ...
              <div className='flex gap-5'>
                <button className='bg-gray-200 text-gray-800 p-3 rounded-lg font-medium hover:bg-gray-300 transition-all duration-200 ease-in h-10 flex justify-center items-center'>Sign in</button>
